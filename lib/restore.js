...
import { delay, requestKey, normalizeURL, toBool, smartSplit, loadSnapshot, decodeBody } from './util.js';

export default async function restoreLogic(opts) {
    const args = Object.assign(
        {},
        {
            ...
            wait: 360, // keep the browser open (seconds)
    ...
    page.on('close', () => {
        if (webContents) webContents.send('restore-finished');
...
export { restorePage, processArgs };
